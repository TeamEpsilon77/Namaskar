...
import 'Ghodejatra.dart';

class Pashupati extends StatefulWidget {
  @override
  HomeState createState() => HomeState();
}

class HomeState extends State<Pashupati> {
  ...
  void initState() {
    ...
    itemRef = database.reference(
        ...
        'Events');
    itemRef.onChildAdded.listen(
        _onEntryAdded);
    itemRef.onChildChanged.listen(
        _onEntryChanged);
  }
